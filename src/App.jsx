    ...
    <>
      <div style={{
        ...
        <input style={{
          ...
          marginBottom: "8px",
          borderRadius: "15px"
        }} placeholder='Search Transactions' onChange={(e) => { setFilter(e.target.value); setPage(1) }}></input>


        {/* <label htmlFor="monthDropdown">Select Month:</label> */}
        <select style={{ left: "75%", position: "sticky", padding: "8px", borderBottomLeftRadius: "8px", borderTopLeftRadius: "8px" }} id="monthDropdown" value={selectedMonth} onChange={(e) => { setSelectedMonth(e.target.value); setPage(1) }}>
